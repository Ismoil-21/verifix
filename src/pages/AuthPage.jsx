// pages/AuthPage.jsx - COMPLETE VERSION
    ...
    <div className="min-h-screen flex items-center bg-blue-700 justify-center p-4 relative overflow-hidden">
      <div className="relative w-full max-w-md z-10">
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center gap-3 bg-white px-6 py-3 rounded-2xl shadow-2xl transform hover:scale-105 transition-transform">
            <Shield className="w-10 h-10 text-blue-600" />
            <h1 className="text-3xl font-bold text-gray-800">Verifix</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 animate-slide-up">
          <div className="flex gap-2 mb-8 bg-gray-100 p-1 rounded-xl sticky top-4">
            <button
              onClick={() => {
          ...
          <form onSubmit={handleSubmit} className="space-y-5 h-88 overflow-scroll">
            {!isLoginMode && (
              ...
              <div className="animate-fade-in">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none bg-white transition-all cursor-pointer`}
                  >
